...
function Scene0030:initialize(sceneManager)
    ...
    table.insert(segments, function()
        return DialogueSegment("scene0030/friendsPreDeath.txt", player, self.camera)
    end)
    ...
    table.insert(segments, function()
        return DialogueSegment("scene0030/friendsPostDeath.txt", player, self.camera)
    end)
    ...
    table.insert(segments, function()
        return DialogueSegment("scene0030/cursedNeuronIntros.txt", player, self.camera)
    end)
    ...
    table.insert(segments, function()
        return DialogueSegment("scene0030/cursedNeuronIntros2.txt", player, self.camera)
    end)
